...
// Ex. 3 Task 1.1: Add @Service annotations to MapClientRepository, BankingImpl, BankReportServiceImpl
@Service
public class BankingImpl implements Banking {
    ...
    // Ex. 2 Task 1.3: Mark repository field of BankingImpl class with @Autowired annotation.
    @Autowired
